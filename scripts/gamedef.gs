...
#def MAXCOINS			100		// max number of coins or diamonds to find (set it to the number of coins you added in your map)
...
#def PLAYER_BEGINX		824		// set the starting positon x of the player in map (when a new game begins)
#def PLAYER_BEGINY		982		// set the starting positon y of the player in map (when a new game begins)
