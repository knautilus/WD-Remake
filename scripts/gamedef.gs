...
#def MAXCOINS			99		// 99 + 1 secret coin
...
#def PLAYER_H			24		// set the player's height
#def PLAYER_BEGINX		2872	// set the starting positon x of the player in map (when a new game begins)
#def PLAYER_BEGINY		550		// set the starting positon y of the player in map (when a new game begins)
